...
A package for accessing the `MPESA Daraja API <https://developers.safaricom.co.ke>`_ from `asyncio <https://docs.python.org/3/library/asyncio.html>`_.
...
- To develop an async wrapper for the `Safaricom daraja api <https://developers.safaricom.co.ke>`_

Contribution
------------
Follow the `contribution guidelines <https://github.com/musale/aiompesa>`_
